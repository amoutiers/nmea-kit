...
| **NMEA sentences** | 46 (bidirectional: parse + encode) |
...
| Waypoints & Routes | AAM, APB, BOD, BWC, BWW, RMB, WPL, XTE |
...
| ---------------------- | ----------------------------------- | ---------------------------------------- |
| NMEA sentence coverage | ~10 types, rest manual              | 46 types, all typed                      |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------------------- |
| `nmea`                                                                                                                                                                                                         | yes        | All 46 NMEA sentence types |
...
| `aam`, `apb`, `bod`, `bwc`, `bwr`, `bww`, `dbk`, `dbs`, `dbt`, `dpt`, `dtm`, `gbs`, `gga`, `gll`, `gns`, `gsa`, `gsv`, `gst`, `hdg`, `hdm`, `hdt`, `mda`, `mtw`, `mwd`, `mwv`, `pashr`, `pgrme`, `pskpdpt`, `rmb`, `rmc`, `rot`, `rpm`, `rsa`, `rsd`, `ths`, `tll`, `ttm`, `txt`, `vbw`, `vdr`, `vhw`, `vlw`, `vtg`, `vwr`, `wpl`, `xdr`, `xte`, `zda` | via `nmea` | Individual sentence types  |
