...
- **21 NMEA sentence types** — parse and encode with checksum
...
|-------|--------------------------|------------|
| Sentence coverage | ~10 types, rest manual | 21 types, all typed |
...
|---------|---------|-------------|
| `nmea` | yes | All 21 NMEA sentence types |
| `ais` | yes | AIS message decoding |
| `dbk`, `dbs`, `dbt`, `dpt`, `gbs`, `gga`, `gll`, `gns`, `gst`, `hdg`, `hdm`, `hdt`, `mwd`, `mwv`, `rmb`, `rmc`, `rot`, `vhw`, `vtg`, `xdr`, `zda` | via `nmea` | Individual sentence types |
