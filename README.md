...
| **NMEA sentences** | 63 (bidirectional: parse + encode) |
...
| ---------------------- | ----------------------------------- | ---------------------------------------- |
| NMEA sentence coverage | ~10 types, rest manual              | 63 NMEA types + 3 AIS sentences          |
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | -------------------------- |
| `nmea`                                                                                                                                                                                                         | yes        | All 63 NMEA sentence types |
